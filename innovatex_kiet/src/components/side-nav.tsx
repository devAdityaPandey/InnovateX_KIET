      ...
      {item.submenu ? (
        <>
          <button
            ...
            className={`flex flex-row items-center p-2 rounded-lg hover:bg-zinc-100 dark:hover:bg-gray-800 w-full justify-between ${
        ...
        <Link
          href={item.path}
          className={`flex flex-row space-x-4 items-center p-2 rounded-lg hover:bg-zinc-100 dark:hover:bg-gray-800 ${
