...
import { connect } from "@/db/db"; // Connect to the MongoDB database
import User from "@/models/userModel"; // Import the User model (for accessing the user data in the database)
